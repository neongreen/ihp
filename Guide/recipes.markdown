...
## How to verify IHP-created password hashes in JavaScript / TypeScript
...
// Checks password stored in pwstore-fast format (which IHP uses). 'pwstring' comes from the database.
